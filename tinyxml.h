...
public:
	...
	*/
	...
	static int Split(_bstr_t m_innerText,_bstr_t spobj,int NeedRemoveEmpty,CStringArray &retls);
	TiXmlNode* SelectNode( const char * _value );
...
public:
	...
	int SetNodeText(const char * NodeName,const char * nodeText);
	const char * GetNodeText(const char * NodeName);
	TiXmlElement* AddNode(const char * NodeName,int nodeValue);
	TiXmlElement* AddNode(const char * NodeName,const char * nodeValue);
...
public:
	...
	*/
	...
	bool LoadFromString(const char * buffer, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );

	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given filename. Returns true if successful.
	
	int GetXml(char * buf,int maxlen);
